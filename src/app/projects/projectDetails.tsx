...
export function ProjectDetails({ hackAddress, chainId }: ProjectDetailsProps) {
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="mt-2 text-slate-300">
                  A decentralized finance aggregator that combines multiple DeFi
                  protocols to provide users with the best possible trading
                  rates and yield farming opportunities.
                </p>
              </div>
            </CardContent>
          </Card>
